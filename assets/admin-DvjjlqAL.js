import{D as l,s as p,c as G,g as V,f as z}from"./dataManager-B2lDTfgR.js";document.addEventListener("DOMContentLoaded",async()=>{await l.initCloud(),J(),Q(),W(),Y()});function J(){const e=document.getElementById("password-screen"),t=document.getElementById("admin-app"),a=document.getElementById("admin-login-btn"),s=document.getElementById("admin-password"),n=document.getElementById("login-error");if(sessionStorage.getItem("admin_authenticated")==="true"){e.style.display="none",t.style.display="flex",w("personal"),setTimeout(L,100);return}a.addEventListener("click",()=>o()),s.addEventListener("keydown",i=>{i.key==="Enter"&&o()});async function o(){const i=s.value;await l.verifyPassword(i)?(sessionStorage.setItem("admin_authenticated","true"),e.style.display="none",t.style.display="flex",w("personal"),setTimeout(L,100)):(n.textContent="Incorrect password. Try again.",n.style.display="block",s.value="",s.classList.add("shake"),setTimeout(()=>s.classList.remove("shake"),500))}}let R="personal";function Q(){const e=document.querySelectorAll(".admin-sidebar__link"),t=document.getElementById("sidebar-toggle"),a=document.querySelector(".admin-sidebar"),s=document.getElementById("sidebar-overlay");e.forEach(n=>{n.addEventListener("click",o=>{o.preventDefault();const i=n.dataset.section;i&&(e.forEach(r=>r.classList.remove("active")),e.forEach(r=>r.classList.remove("admin-sidebar__link--active")),n.classList.add("active"),n.classList.add("admin-sidebar__link--active"),w(i),a&&a.classList.remove("sidebar-open"),s&&s.classList.remove("overlay-active"))})}),t&&a&&t.addEventListener("click",()=>{a.classList.toggle("sidebar-open"),s&&s.classList.toggle("overlay-active")}),s&&s.addEventListener("click",()=>{a&&a.classList.remove("sidebar-open"),s.classList.remove("overlay-active")}),window.addEventListener("resize",()=>{window.innerWidth>900&&(a&&a.classList.contains("sidebar-open")&&a.classList.remove("sidebar-open"),s&&s.classList.contains("overlay-active")&&s.classList.remove("overlay-active"))})}function W(){const e=document.getElementById("export-btn"),t=document.getElementById("import-btn"),a=document.getElementById("import-file-input"),s=document.getElementById("save-all-btn");e&&e.addEventListener("click",()=>{l.exportData(),p("Data exported successfully!","success")}),t&&a&&(t.addEventListener("click",()=>a.click()),a.addEventListener("change",async n=>{const o=n.target.files[0];if(o)try{await l.importData(o),p("Data imported successfully! Reloading...","success"),setTimeout(()=>{w(R)},1e3)}catch(i){p("Import failed: "+i.message,"error")}})),s&&s.addEventListener("click",()=>{p("All changes are auto-saved!","info")})}let x=null;function Y(){const e=document.getElementById("admin-modal"),t=document.getElementById("modal-confirm-btn"),a=document.getElementById("modal-cancel-btn");t&&t.addEventListener("click",()=>{e&&e.classList.remove("is-open"),x&&x(!0)}),a&&a.addEventListener("click",()=>{e&&e.classList.remove("is-open"),x&&x(!1)})}function $(e,t){const a=document.getElementById("admin-modal"),s=document.getElementById("modal-title"),n=document.getElementById("modal-message");return s&&(s.textContent=e),n&&(n.textContent=t),a&&a.classList.add("is-open"),new Promise(o=>{x=o})}function w(e){R=e;const t=document.getElementById("admin-page-title"),a={personal:"👤 Personal Info",education:"🎓 Education",professionalQualifications:"🏆 Professional Qualifications",vocationalQualifications:"📜 Vocational Qualifications",experience:"💼 Experience",skills:"⚡ Skills",competencies:"🎯 Competencies",achievements:"🏅 Achievements",personality:"🧠 Personality",interests:"🎮 Interests & Hobbies",swot:"📊 SWOT Analysis",values:"✨ Values",goals:"🎯 Goals",gapAnalysis:"📈 Gap Analysis",actionPlan:"📋 Action Plan",projects:"🚀 Projects",messages:"📬 Messages Inbox",settings:"⚙️ Settings"};t&&(t.textContent=a[e]||e),document.querySelectorAll(".admin-section").forEach(i=>{i.style.display="none";const r=i.querySelector('[id$="-form-container"]');r&&i.id!==`section-${e}`&&(r.innerHTML="",r.style.display="none")});const s=document.getElementById(`section-${e}`);s&&(s.style.display="block");const o={personal:re,education:()=>v("education",X),professionalQualifications:()=>v("professionalQualifications",Z),vocationalQualifications:()=>v("vocationalQualifications",K),experience:()=>v("experience",ee),skills:()=>v("skills",te),competencies:()=>v("competencies",ae),achievements:()=>v("achievements",ne),personality:de,interests:()=>v("interests",se),swot:ce,values:()=>v("values",oe),goals:I,gapAnalysis:S,actionPlan:_,projects:()=>v("projects",ie),messages:B,settings:pe}[e];o&&o()}const X=[{key:"degree",label:"Degree / Certificate",type:"text",required:!0},{key:"institution",label:"Institution",type:"text",required:!0},{key:"year",label:"Year / Period",type:"text"},{key:"gpa",label:"GPA",type:"text"},{key:"description",label:"Description",type:"textarea"}],Z=[{key:"title",label:"Title",type:"text",required:!0},{key:"issuer",label:"Issuing Organization",type:"text"},{key:"date",label:"Date",type:"text"},{key:"description",label:"Description",type:"textarea"},{key:"credentialUrl",label:"Credential URL",type:"url"}],K=[{key:"title",label:"Title",type:"text",required:!0},{key:"issuer",label:"Issuing Organization",type:"text"},{key:"date",label:"Date",type:"text"},{key:"description",label:"Description",type:"textarea"}],ee=[{key:"role",label:"Role / Position",type:"text",required:!0},{key:"company",label:"Company / Organization",type:"text",required:!0},{key:"period",label:"Period",type:"text"},{key:"description",label:"Description",type:"textarea"},{key:"type",label:"Type",type:"select",options:["work","internship","volunteer","freelance"]}],te=[{key:"name",label:"Skill Name",type:"text",required:!0},{key:"level",label:"Proficiency Level (0-100)",type:"range",min:0,max:100},{key:"category",label:"Category",type:"text"}],ae=[{key:"name",label:"Competency Name",type:"text",required:!0},{key:"description",label:"Description",type:"textarea"}],ne=[{key:"title",label:"Achievement Title",type:"text",required:!0},{key:"description",label:"Description",type:"textarea"},{key:"date",label:"Date",type:"text"},{key:"category",label:"Category",type:"select",options:["Academic","Professional","Personal","Competition","Other"]}],se=[{key:"name",label:"Interest Name",type:"text",required:!0},{key:"icon",label:"Icon (emoji)",type:"text"},{key:"description",label:"Description",type:"textarea"}],oe=[{key:"name",label:"Value Name",type:"text",required:!0},{key:"description",label:"Description",type:"textarea"}],ie=[{key:"title",label:"Project Title",type:"text",required:!0},{key:"description",label:"Description",type:"textarea"},{key:"techStack",label:"Tech Stack (comma-separated)",type:"text"},{key:"liveUrl",label:"Live Demo URL",type:"url"},{key:"githubUrl",label:"GitHub URL",type:"url"},{key:"youtubeUrl",label:"YouTube URL",type:"url"},{key:"category",label:"Category",type:"text"},{key:"featured",label:"Featured",type:"checkbox"}];function re(){var o,i,r,d,b,f,m,y;const e=document.getElementById("section-personal");if(!e)return;const t=l.getSection("personal");e.innerHTML=`
    <form id="personal-form" class="admin-form">
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <input type="url" id="personal-tiktok" name="tiktok" value="${c(((f=t.socialLinks)==null?void 0:f.tiktok)||"")}" />
        </div>
      </div>
      <div class="form-row">
        <div class="form-group">
  ...
  `,document.getElementById(`add-${e}-btn`).addEventListener("click",()=>{C(e,null,t,o)}),a.querySelectorAll(".item-edit-btn").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id,d=n.find(b=>b.id===r);d&&C(e,d,t,o)})}),a.querySelectorAll(".item-delete-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.id;await $("Delete Item","Are you sure you want to delete this item? This cannot be undone.")&&(l.deleteItem(e,r),v(e,t),p("Item deleted","success"))})})}function le(e,t,a){const s=a[0],n=a.length>1?a[1]:null,o=t[s.key]||"Untitled",i=n&&t[n.key]||"";let r=o;Array.isArray(o)&&(r=o.join(", "));let d=i;Array.isArray(i)&&(d=i.join(", "));const b=t.level!==void 0?`<div class="item-level-bar"><div class="item-level-fill" style="width:${t.level}%"></div><span>${t.level}%</span></div>`:"",f=t.proofs?t.proofs.length:0,m=f>0?`<span class="item-proofs-badge">📎 ${f} proof${f>1?"s":""}</span>`:"";return`
  ...
  `}function C(e,t,a,s){const n=document.getElementById(`${e}-form-container`);if(!n)return;const o=!!t,i=e;n.style.display="block",n.innerHTML=`
  ...
  `,n.scrollIntoView({behavior:"smooth",block:"center"}),document.getElementById(`${i}-cancel-btn`).addEventListener("click",()=>{n.style.display="none",n.innerHTML=""});const r=document.getElementById(`${i}-item-form`);r.addEventListener("submit",d=>{d.preventDefault();const b=new FormData(r),f={};a.forEach(m=>{let y=b.get(m.key);m.type==="checkbox"?y=r.querySelector(`[name="${m.key}"]`).checked:m.type==="range"?y=parseInt(y)||0:m.key==="techStack"&&(y=y?y.split(",").map(g=>g.trim()).filter(Boolean):[]),f[m.key]=y||""}),o?(f.id=t.id,f.proofs=t.proofs||[],l.updateItem(e,t.id,f),p("Item updated!","success")):(f.id=l.generateId(e.substring(0,3)),f.proofs=[],l.addItem(e,f),p("Item added!","success")),n.style.display="none",n.innerHTML="",v(e,a)}),s&&O(e,t)}function j(e,t){const a=t?t[e.key]||"":e.default||"",s=Array.isArray(a)?a.join(", "):a,n=e.required?"required":"";switch(e.type){case"textarea":return`
        <div class="form-group">
  ...
  `}function O(e,t){if(!t)return;const a=document.getElementById(`${e}-form-container`);if(!a)return;const s=a.querySelector("#proof-drop-area"),n=a.querySelector("#proof-file-input"),o=a.querySelector("#youtube-proof-url"),i=a.querySelector("#add-youtube-proof-btn"),r=a.querySelector("#link-proof-url"),d=a.querySelector("#link-proof-name"),b=a.querySelector("#add-link-proof-btn");s&&n&&(s.addEventListener("click",()=>n.click()),s.addEventListener("dragover",m=>{m.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",m=>{m.preventDefault(),s.classList.remove("drag-over"),q(m.dataTransfer.files,e,t)}),n.addEventListener("change",m=>{q(m.target.files,e,t)})),i&&o&&i.addEventListener("click",()=>{const m=o.value.trim();if(m){const y={type:"youtube",url:m,name:"YouTube Video"};l.addProof(e,t.id,y),t.proofs=t.proofs||[],t.proofs.push(y),o.value="",p("YouTube proof added!","success"),E(e,t)}}),b&&r&&d&&b.addEventListener("click",()=>{const m=r.value.trim();let y=d.value.trim();if(m){y||(y="External Link");let g="document";const u=m.toLowerCase();u.match(/\.(jpeg|jpg|gif|png|webp|svg|avif)/)?g="image":u.endsWith(".pdf")?g="pdf":u.match(/\.(mp4|webm|ogg|mov|avi)/)&&(g="video");const k={type:g,url:m,name:y};l.addProof(e,t.id,k),t.proofs=t.proofs||[],t.proofs.push(k),r.value="",d.value="",p("Proof URL added!","success"),E(e,t)}else p("Please enter a valid URL.","warning")});const f=a.querySelector("#proof-list");f&&f.addEventListener("click",m=>{const y=m.target.closest(".proof-remove-btn");if(y){const g=parseInt(y.dataset.index);l.removeProof(e,t.id,g),t.proofs.splice(g,1),E(e,t),p("Proof removed","success")}})}async function q(e,t,a){for(const n of e){if(n.size>1572864){p(`Failed to upload ${n.name}: File is too large. Please use files under 1.5 MB.`,"error");continue}try{const o=V(n.name);let i;o==="image"?i=await G(n,1200,.75):i=await z(n);const r={type:o,url:i,name:n.name};if(!l.addProof(t,a.id,r)){p(`Failed to upload ${n.name}: Storage limit reached.`,"error");continue}a.proofs=a.proofs||[],a.proofs.push(r);const b=l.getCloudConfig();b.apiKey&&b.binId&&n.size>80*1024?p(`"${n.name}" uploaded locally. Since it exceeds 80KB, it cannot sync to the 100KB cloud database. We recommend adding it via URL instead!`,"warning",7e3):p(`Proof "${n.name}" uploaded!`,"success")}catch(o){p(`Failed to upload ${n.name}: ${o.message}`,"error")}}E(t,a)}function E(e,t){const a=document.getElementById(`${e}-form-container`);if(!a)return;const s=a.querySelector("#proof-list");if(!s)return;const n=t.proofs||[];s.innerHTML=n.map((o,i)=>`
    <div class="proof-upload-item">
      <span class="proof-upload-icon">${o.type==="image"?"🖼️":o.type==="pdf"?"📄":o.type==="youtube"?"▶️":"📎"}</span>
      <span class="proof-upload-name">${c(o.name||"Proof")}</span>
  ...
  `,O("personality",t);const a=document.getElementById("personality-form");a.addEventListener("submit",s=>{s.preventDefault();const n=new FormData(a),o={...t,mbtiType:n.get("mbtiType"),mbtiLabel:n.get("mbtiLabel"),mbtiDescription:n.get("mbtiDescription"),careerKeyResults:n.get("careerKeyResults")};l.updateSection("personality",o),p("Personality info saved!","success")})}function ce(){const e=document.getElementById("section-swot");if(!e)return;const t=l.getSection("swot"),a=[{key:"strengths",label:"💪 Strengths",color:"cyan"},{key:"weaknesses",label:"⚠️ Weaknesses",color:"pink"},{key:"opportunities",label:"🚀 Opportunities",color:"emerald"},{key:"threats",label:"🔥 Threats",color:"amber"}];e.innerHTML=`
  ...
  `,e.querySelectorAll(".swot-add").forEach(n=>{n.addEventListener("click",()=>{const o=n.dataset.quadrant,i=document.getElementById(`swot-${o}-items`),r=i.children.length,d=document.createElement("div");d.className="swot-form-item",d.innerHTML=`
      ...
      `,i.appendChild(d),d.querySelector("input").focus()})}),e.addEventListener("click",n=>{n.target.classList.contains("swot-remove")&&n.target.closest(".swot-form-item").remove()});const s=document.getElementById("swot-form");s.addEventListener("submit",n=>{n.preventDefault();const o={};a.forEach(i=>{const r=[];s.querySelectorAll(`[name^="${i.key}-"]`).forEach(b=>{const f=b.value.trim();f&&r.push(f)}),o[i.key]=r}),l.updateSection("swot",o),p("SWOT Analysis saved!","success")})}function I(){const e=document.getElementById("section-goals");if(!e)return;const t=l.getSection("goals");let a="smart";function s(n){return`
      <div class="item-list">
        ${(t[n]||[]).map(i=>`
          <div class="item-card glass-card">
            <div class="item-info">
  ...
  `,document.getElementById("goal-cancel-btn").addEventListener("click",()=>{s.style.display="none"}),document.getElementById("goal-edit-form").addEventListener("submit",i=>{i.preventDefault();const r=new FormData(i.target),d={};if(o.forEach(b=>{let f=r.get(b.key);b.type==="range"&&(f=parseInt(f)||0),d[b.key]=f||""}),n){d.id=t.id;const b=a[e].findIndex(f=>f.id===t.id);b>=0&&(a[e][b]=d)}else d.id=l.generateId(e),a[e]=a[e]||[],a[e].push(d);l.updateSection("goals",a),I(),p(`Goal ${n?"updated":"added"}!`,"success")})}function S(){const e=document.getElementById("section-gapAnalysis");if(!e)return;const t=l.getSection("gapAnalysis");let a="knowledge";function s(n){return`
      <div class="item-list">
        ${(t[n]||[]).map(i=>`
          <div class="item-card glass-card">
            <div class="item-info">
